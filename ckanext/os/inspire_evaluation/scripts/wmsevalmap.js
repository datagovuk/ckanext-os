...
Ext.onReady(function(){
    ...
    tiled = new OpenLayers.Layer.WMS("OS Base Mapping", "http://mappingserver/geoserver/gwc/service/wms?key=geoserverkey", {
		LAYERS: 'InspireETRS89',
        styles: '',
        format: 'image/png',
        tiled: true
	...
	// overview	layer
	var overviewLayer = new OpenLayers.Layer.WMS("Geoserver layers - nonTiled", "http://mappingserver/geoserver/wms?key=geoserverkey", {
		LAYERS: 'sea_dtm,overview_layers',
		STYLES: '',
		format: 'image/png',
		tiled: false
    ...
    for (var i = 0; i < validUrls.length; i++) {
        ...
        child = {
            ...
            loader: new os.WMSCapabilitiesLoader({
				...
				// COI
				//url: '/sites/all/modules/_custom/UKLP_UI/eval/proxy.php?url=' + urlWmsSuffix, 
                
				// Ordnance Survey
				url: 'proxy.php?url=' + urlWmsSuffix, 
                layerOptions: {
                    buffer: 0
                    ,singleTile: true
                    ,ratio: 1
